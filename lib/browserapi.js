  ...
  if (filter?.trim()) {
    ...
    if (range) {
      ...
      sorted = sorted.filter(x =>
        ...
        x.fullName.toLowerCase().split(' ').filter(c => c.startsWith(filter2)).length > 0 ||
        x.homeClub?.toLowerCase().split(' ').filter(c => c.startsWith(filter2)).length > 0 ||
        (
...
export const getSchedules = (allMatches, filter) => {
  ...
  if (filter?.trim()) {
    ...
    return originalIndex.filter(x =>
      x.between[0].name.toLowerCase().startsWith(filter2) ||
      x.between[1].name.toLowerCase().startsWith(filter2) ||

      x.between[0].players[0]?.fullName.toLowerCase().startsWith(filter2) ||
      x.between[0].players[1]?.fullName.toLowerCase().startsWith(filter2) ||

      x.between[1].players[0]?.fullName.toLowerCase().startsWith(filter2) ||
      x.between[1].players[1]?.fullName.toLowerCase().startsWith(filter2) ||

      x.between[0].players[0]?.nickName.toLowerCase().startsWith(filter2) ||
      x.between[0].players[1]?.nickName.toLowerCase().startsWith(filter2) ||

      x.between[1].players[0]?.nickName.toLowerCase().startsWith(filter2) ||
      x.between[1].players[1]?.nickName.toLowerCase().startsWith(filter2)
    )
  }
...
export const getFilteredMatches = (allMatches, filter) => {
  if (filter?.trim()) {
    ...
    return allMatches.filter(x =>
      x.winners.players[0]?.fullName.toLowerCase().startsWith(filter2) ||
      x.winners.players[1]?.fullName.toLowerCase().startsWith(filter2) ||

      x.losers.players[0]?.fullName.toLowerCase().startsWith(filter2) ||
      x.losers.players[1]?.fullName.toLowerCase().startsWith(filter2) ||

      x.winners.players[0]?.nickName.toLowerCase().startsWith(filter2) ||
      x.winners.players[1]?.nickName.toLowerCase().startsWith(filter2) ||

      x.losers.players[0]?.nickName.toLowerCase().startsWith(filter2) ||
      x.losers.players[1]?.nickName.toLowerCase().startsWith(filter2)
    )
  }
